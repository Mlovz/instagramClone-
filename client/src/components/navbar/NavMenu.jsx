...
const NavMenu = () => {
  ...
  return (
    <ul className="nav__menu__list">
      ...
      <li className="nav__menu__item">
        <Link to="/direct" className="nav__menu__link">
      ...
      <li className="nav__menu__item" onClick={() => setAddPost(true)}>
      ...
      <li className="nav__menu__item">
        <Link to="/explore" className="nav__menu__link">
          <svg
      ...
      <li className="nav__menu__item">
        <div className="nav__menu__link" onClick={() => setNotifyModal(!notifyModal)}>
          {notifyModal ? (
            <svg
          ...
          {
             notify.data.length > 0 && <div className='notify__length'>
      ...
      {addPost && <AddPostModal setAddPost={setAddPost} addPost={addPost} />}
      {notifyModal && <NotifyModal setNotifyModal={setNotifyModal}/>}
    </ul>
  );
};
